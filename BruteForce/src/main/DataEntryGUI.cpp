 ...
 * Title:DataEntryGUI
 *
 * Description: Constructor function for the class section selector GUI window.
 *
 *Arguments: nothing
 *
 *Returns: nothing
...
DataEntryGUI::DataEntryGUI(Fl_Window *win, vector<SoupCookie> cookies) {
	...
	/***** Initialize Student Quiz Textbox -
	 * Step 2 Enter name of Capstone Survey *****/
 ...
 * Title: ~DataEntryGUI
 *
 * Description: Destructor function for the class section selector GUI window.
 *
 *Arguments: nothing
 *
 *Returns: nothing
...
void DataEntryGUI::GenerateTeamsClick(Fl_Widget *w) {
	 ...
	 * for use in the assignment system. Prints out courses*/
 ...
 * Tile: quit_cb
 *
 * Description: Callback: when user picks 'Quit'
 *
 *Arguments: FL_Widget* w, void *
 *
 *Returns: nothing
 */
